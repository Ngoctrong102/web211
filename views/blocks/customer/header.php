    ...
    <div id="cover-right">
        <div id="cover-right-top">
            ...
            <img style="width: 40px; height: 35px; margin:auto 0px" src="https://cdn.shopify.com/s/files/1/0049/8407/8400/files/icon-phone_small.png?v=1543293717">
                <p style="margin-left: 5px">Phone:<br />+84282828289</p>
            </div>
            <!--search-->
            <div id="search">
            ...
            <div id="cart">
                <div onmouseover="total()"id="hover-objects">
                    <a href="#"><span class="material-icons-outlined" style="padding: 0 10px; width: 60px; height: 60px; font-size: 50px; margin: auto">shopping_bag</span><span>Shopping Cart</span></a>
                    <br/>
                    <ul>
