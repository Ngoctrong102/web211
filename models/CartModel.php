...
class CartModel extends BaseModel
{
    ...
    {
        $stmt = $this->conn->prepare("SELECT product.id, product.name, product.thumbnails, product.price, product_cart.quantity,unit_id FROM (product JOIN product_cart ON product.id = product_cart.product_id)");
